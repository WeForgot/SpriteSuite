                        ...
                        if 'Betting open' in message:
                            ...
                            try:
                                ...
                                current_info = BettingInformation(raw_blue, split_blue[0], split_blue[1], split_blue[2], split_blue[3],
                                                                ...
                                                                coordinates[match_array[4]] if split_red[0] != 0 else None, 
                                                                coordinates[match_array[5]] if split_red[1] != 0 else None, 
                                                                coordinates[match_array[6]] if split_red[2] != 0 else None, 
                                                                coordinates[match_array[7]] if split_red[3] != 0 else None, 
